...
import br.com.pontointeligente.api.dtos.LancamentoDto;
...
public class LancamentoController {
    ...
    public ResponseEntity<Response<Page<LancamentoDto>>> listarPorFuncionarioId(
        ...
        final Response<Page<LancamentoDto>> response = new Response<Page<LancamentoDto>>();

        final PageRequest pageRequest = new PageRequest(pag, this.qtdPorPagina, Direction.valueOf(dir), ord);
        final Page<Lancamento> lancamentos = this.lancamentoService.buscarPorFuncionarioId(funcionarioId, pageRequest);
        final Page<LancamentoDto> lancamentosDto = lancamentos.map(lancamento -> this.converterLancamentoDto(lancamento));
    ...
    public ResponseEntity<Response<LancamentoDto>> listarPorId(@PathVariable("id") Long id) {
        ...
        final Response<LancamentoDto> response = new Response<LancamentoDto>();
        final Optional<Lancamento> lancamento = this.lancamentoService.buscarPorId(id);
    ...
    private void validarFuncionario(LancamentoDto lancamentoDto, BindingResult result) {
        ...
        final Optional<Funcionario> funcionario = this.funcionarioService.buscarPorId(lancamentoDto.getFuncionarioId());
