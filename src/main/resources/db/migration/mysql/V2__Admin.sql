...
VALUES (NULL, '82198127000121', CURRENT_DATE(), CURRENT_DATE(), 'Company');
...
VALUES (NULL, '16248890935', CURRENT_DATE(), CURRENT_DATE(), 'admin@company.com', 'ADMIN', 'ROLE_ADMIN', NULL, NULL,
