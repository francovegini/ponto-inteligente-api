...
public class LancamentoServiceTest {
    ...
    public void testBuscarLancamentoPorFuncionarioId() {
        final Page<Lancamento> lancamento = this.lancamentoService.buscarPorFuncionarioId(1L, new PageRequest(0, 10));
    ...
    public void testBuscarLancamentoPorId() {
        final Optional<Lancamento> lancamento = this.lancamentoService.buscarPorId(1L);
    ...
    public void testPersistirLancamento() {
        final Lancamento lancamento = this.lancamentoService.persistir(new Lancamento());
